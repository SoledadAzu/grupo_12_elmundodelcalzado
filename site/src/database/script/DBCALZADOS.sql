...
--
-- Host: localhost    Database: db_el_mundo_del_calzado
-- ------------------------------------------------------
...
CREATE TABLE `productos` (
  ...
  `id_temporadas` int DEFAULT NULL,
  `outlets` int DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `sequelizemeta` VALUES ('20211127235846-create-temporadas.js'),('20211128000108-create-outlets.js'),('20211128000539-create-generos.js'),('20211128001351-create-productos.js'),('20211128001516-create-colores.js'),('20211128001553-create-talles.js'),('20211128001621-create-detalles.js'),('20211128001845-create-imagenes-productos.js'),('20211128002004-create-categoria-usuarios.js'),('20211128002403-create-usuarios.js'),('20211128002547-create-orden.js'),('20211128002732-create-carrito-de-compra.js'),('20211128010110-create-marcas.js');
...
CREATE TABLE `usuarios` (
  ...
  `id_categoria_usuario` int DEFAULT NULL,
...
-- Dump completed on 2021-11-27 23:50:39
